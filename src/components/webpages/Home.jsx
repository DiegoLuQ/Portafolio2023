...
const Home = () => {
  const { loading } = useContext(DatosContext);
  if (loading)
    return (
      <div role="status" className="h-[100vh] flex justify-center items-center">
        <div className="relative flex flex-col items-center gap-5">
          <h2 className="text-4xl text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-[#00ad0e]">Dedicación y Tiempo</h2>
          <svg
            aria-hidden="true"
